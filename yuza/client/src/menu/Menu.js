        ...
        <>
            <header className="navbar sticky">
                ...
                <ul className="menu-items">
                    ...
                    <li><Link to="/board/jokbo" key={key} onClick={handlerMenuClick} className="menu-item first-item">족보게시판</Link></li>
                    <li>
                        <a href="#" className="menu-item first-item">질문게시판</a>
                    </li>
                    <li>
                        <Link to="/board/free" key={key} onClick={handlerMenuClick} className="menu-item first-item">자유게시판</Link>
                    </li>
                    <UserSubmenu />
                    {/* 기존 코드:
